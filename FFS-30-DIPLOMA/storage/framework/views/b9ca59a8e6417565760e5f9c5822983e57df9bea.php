  ...
  <main>
    <section class="login">
      ...
      <div class="login__wrapper">
        <form class="login__form" method="POST" action="<?php echo e(route('login')); ?>" accept-charset="utf-8">
        <?php echo csrf_field(); ?>
          <label class="login__label" for="mail">
            E-mail
            <input id="email" class="login__input" type="email" name="email" :value="old('email')" name="email" required autofocus>
          </label>
...
<?php /**PATH C:\Users\artem\Desktop\Netology\lrv-DIPLOMA-test\FFS-30-DIPLOMA\resources\views/auth/login.blade.php ENDPATH**/ ?>