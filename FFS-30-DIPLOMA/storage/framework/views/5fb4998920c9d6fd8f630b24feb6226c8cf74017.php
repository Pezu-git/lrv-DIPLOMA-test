    ...
    <section class="buying">
      <div class="buying__info">
        <div class="buying__info-description">
          <h2 class="buying__info-title"><?php echo e($movie_title); ?></h2>
          <p class="buying__info-start">Начало сеанса: <?php echo e($start_time); ?></p>
          <p class="buying__info-hall"><?php echo e($hall_name); ?></p>
        </div>
      ...
      <div class="buying-scheme">
        <div class="buying-scheme__wrapper">
          <?php for($j = 0; $j < hallConfRow($hall); $j++): ?> <div class="buying-scheme__row">
            <?php for($k = 0; $k < hallConfCol($hall); $k++): ?> <span class="buying-scheme__chair buying-scheme__chair_<?php echo e(hallSeats($hall, $j, $k)); ?>"></span>
              <?php endfor; ?>
        </div>
        <?php endfor; ?>
      </div>
      ...
      <div class="buying-scheme__legend">
        <div class="col">
          <p class="buying-scheme__legend-price"><span class="buying-scheme__chair buying-scheme__chair_standart"></span> Свободно (<span class="buying-scheme__legend-value"><?php echo e($hall_price_standart); ?></span>руб)</p>
          <p class="buying-scheme__legend-price"><span class="buying-scheme__chair buying-scheme__chair_vip"></span> Свободно VIP (<span class="buying-scheme__legend-value"><?php echo e($hall_price_vip); ?></span>руб)</p>
        </div>
        <div class="col">
...
</html><?php /**PATH C:\Users\artem\Desktop\Netology\lrv-DIPLOMA-test\FFS-30-DIPLOMA\resources\views/client/hall.blade.php ENDPATH**/ ?>