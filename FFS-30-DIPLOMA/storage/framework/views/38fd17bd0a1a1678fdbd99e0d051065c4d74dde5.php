  ...
  <main>
    <section class="ticket">
      ...
      <div class="ticket__info-wrapper">
        ...
        <p class="ticket__info">Ряд/Место: <span class="ticket__details ticket__chairs"><?php echo e($places); ?></span></p>
        <p class="ticket__info">Зал: <span class="ticket__details ticket__hall"><?php echo e($hall_name); ?></span></p>
        <p class="ticket__info">Начало сеанса: <span class="ticket__details ticket__start"><?php echo e($start_time); ?></span></p>
        <p class="ticket__info">Стоимость: <span class="ticket__details ticket__cost"><?php echo e($price); ?></span> рублей</p>


        <button class="acceptin-button" onclick="location.href=`<?php echo e(route('ticket', ['movie_title' =>$movie_title, 'places'=> $places, 'hall_name' => $hall_name, 'start_time' => $start_time])); ?>`">Получить код бронирования</button>
...
</html><?php /**PATH C:\Users\artem\Desktop\Netology\lrv-DIPLOMA-test\FFS-30-DIPLOMA\resources\views/client/payment.blade.php ENDPATH**/ ?>